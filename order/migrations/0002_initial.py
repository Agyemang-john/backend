...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='shipment',
            name='items',
            field=models.ManyToManyField(related_name='shipments', to='order.orderproduct'),
        ),
        migrations.AddField(
            model_name='shipment',
            name='order',
        ...
        migrations.AddField(
            ...
            name='shipment',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tracking_events', to='order.shipment'),
        ),
    ]
